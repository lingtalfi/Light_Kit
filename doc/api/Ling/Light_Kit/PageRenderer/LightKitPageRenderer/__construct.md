...
LightKitPageRenderer::__construct
================



LightKitPageRenderer::__construct — Builds the LightKitPageRenderer instance.
...
Source Code
===========
See the source code for method [LightKitPageRenderer::__construct](https://github.com/lingtalfi/Light_Kit/blob/master/PageRenderer/LightKitPageRenderer.php#L59-L66)
...
Next method: [setConfStorage](https://github.com/lingtalfi/Light_Kit/blob/master/doc/api/Ling/Light_Kit/PageRenderer/LightKitPageRenderer/setConfStorage.md)<br>
